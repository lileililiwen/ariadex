...
Define a Python watcher robot that supervises an existing OpenCode, Codex, or
CodeBuddy conversation through tmux, continues durable OpenSpec work with two
configurable prompts, and stops when no active work remains.
