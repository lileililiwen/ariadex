# Provider automatic continuation specification

## Purpose

Require every supported robot provider to automatically create a fresh
conversation and receive the configured continuation prompt after a finished,
durably verified conversation.
