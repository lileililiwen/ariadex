...
## Purpose
Defines robot-owned conversation chores across providers: adapter-declared
model switching with ordered fallbacks, draft/pause preconditions on every
automatic input, and bounded fresh-ready waits that refire the open
boundary instead of shutting down.
## Requirements
