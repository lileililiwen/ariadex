...
## Purpose
Defines correct project provenance and security routing: published metadata, links, and vulnerability-reporting instructions identify Ariadex-owned resources, and a fail-closed release dry run verifies identity URLs, version/tag alignment, build artifacts, and the security route without publishing anything.
## Requirements
