# daemon-widget-record-recovery Specification

## Purpose
Keep stale widget records from crashing daemon readiness; repair them through
the existing ownership-checked replacement path.
## Requirements
