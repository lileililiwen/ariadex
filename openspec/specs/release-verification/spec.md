...
## Purpose
Defines verifiable releases from the canonical repository: origin identity gating, reviewer-approved tag releases through a protected environment, trusted-publisher PyPI publication with recorded hashes, provider-optional live evidence (blocked fails, one real provider pass required, skipped providers reported unevaluated), and clean-index installation proof.
## Requirements
