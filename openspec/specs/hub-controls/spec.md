# hub-controls Specification

## Purpose
Define the movable multi-project hub controls for bounded titlebar dragging and
copying the active tab's activity log without sending provider input.
## Requirements
